    ...
    // console.log(state,'-----------------------')
     ...
     switch (type ) {
        case 'food':
            console.log('hello')
         console.log(payload,'***********')
           let data1=  payload ? payload.products.filter((value) => value.category=== 'food' ):null
        ...
        case 'electronics':
            ...
            let data2 =  payload ? payload.products.filter((value) => value.category=== 'electronics'):null
